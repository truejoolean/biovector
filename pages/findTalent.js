		...
		<section className="mt-8 w-screen-lg">
			...
			<div className="flex mx-auto max-w-screen-lg mt-8">
				<div className="w-1/2 border-r-2">
					<div className="flex flex-col align-items w-96 items-center mx-auto h-56 hover:bg-gray-300">
					...
					<hr className="mt-2"/>
					<div className="flex flex-col align-items w-96 items-center mx-auto mt-4 h-56">
				...
				<div className="w-1/2">
					<div className="flex flex-col align-items w-96 items-center mx-auto h-56">
						<img className="w-24" src="/images/icons/icon_scientist.png" />
						<h2 className="text-xl mt-2">Focussed expertise</h2>
						<p className="text-center mt-2">Having experience in multiple biotechnology enterprises, we know the intricacies of this special labor market.</p>
					</div>
					<hr className="mt-2" />
					<div className="flex flex-col align-items w-96 items-center mx-auto mt-4 h-56">
		...
		<section className="mt-16 max-w-screen-lg mx-auto">
			...
			<table className="mt-4 w-full">
				<tr>
					...
					<th className="w-4/12 bg-blue-900 text-white text-3xl font-normal border p-4">Basic</th>
					<th className="w-4/12 bg-blue-900 text-white text-3xl font-normal border p-4">Pro</th>
				</tr>
				<tr>
					<td className="w-3/12 bg-blue-900 text-white text-xl p-4 text-center font-light">Price</td>
					<td className="border w-4/12 text-center text-2xl">350<span className="text-xs font-normal">€</span></td>
					<td className="border w-4/12 text-center text-2xl">750<span className="text-xs font-normal">€</span></td>
				</tr>
				<tr>
					<td className="w-3/12 bg-blue-900 text-white text-xl p-4 text-center font-light border">Months of exposure</td>
					<td className="border w-4/12 text-center font-bold text-2xl">3</td>
					<td className="border w-4/12 text-center font-bold text-2xl">6</td>
				</tr>
				<tr>
					<td className="w-3/12 bg-blue-900 text-white text-xl p-4 text-center font-light border">Investment into targeted advertisement</td>
					<td className="border w-4/12 text-center font-bold text-2xl">70<span className="text-xs font-normal">€</span></td>
					<td className="border w-4/12 text-center font-bold text-2xl">120<span className="text-xs font-normal">€</span></td>
				</tr>
				<tr>
					<td className="w-3/12 bg-blue-900 text-white text-xl p-4 text-center font-light border">Extra post on Google Jobs</td>
					<td className="border w-4/12 text-center font-bold text-2xl"><img className="mx-auto" src="/images/icons/icon_tick.svg" /></td>
					<td className="border w-4/12 text-center font-bold text-2xl"><img className="mx-auto" src="/images/icons/icon_tick.svg" /></td>
				</tr>
				<tr>
					<td className="w-3/12 bg-blue-900 text-white text-xl p-4 text-center font-light border">Manual management of advertisement campaigns</td>
					<td className="border w-4/12 text-center font-bold text-2xl"><img className="mx-auto" src="/images/icons/icon_tick.svg" /></td>
